...
DATABASE_NAME = environ.get('DATABASE_NAME', "Nishanta")
...
URL = "https://odin-kgfi.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://odin-kgfi.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://odin-kgfi.onrender.com/".format(FQDN)
else:
    URL = "https://odin-kgfi.onrender.com/".format(FQDN)
